 ...
 * @date 2018/12/3
 */
public enum Hbase132ReaderErrorCode implements ErrorCode {
    REQUIRED_VALUE("Hbase132Reader-00", "您缺失了必须填写的参数值."),
    ILLEGAL_VALUE("Hbase132Reader-01", "您填写的参数值不合法."),
    ...
    private Hbase132ReaderErrorCode(String code, String description) {
        this.code = code;
